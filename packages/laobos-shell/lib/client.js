      ...
      function ShellSettingsSection() {
        ...
        return h(
          ...
          h(
            ...
            state?.platform === "win32" && !state?.wsl?.ready && !state?.wsl?.installed ? h("button", { type: "button", className: "lbs-shell-button", disabled: busy, onClick: () => action(() => api.installWsl("Ubuntu")) }, "安装 WSL + Ubuntu") : null,
