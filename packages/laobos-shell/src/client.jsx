...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function ShellSettingsSection() {
      ...
      return h("div", { className: "lbs-shell-page" },
        h("section", { className: "lbs-shell-hero" },
          h("span", { className: "lbs-shell-icon", "aria-hidden": true }, ">_"),
          h("div", { className: "lbs-shell-copy" },
        ...
        state?.phase === "installing" || state?.phase === "verifying" || state?.phase === "detecting"
          ? h("div", { className: "lbs-shell-progress", "data-indeterminate": indeterminate }, h("span", { style: indeterminate ? undefined : { width: `${percent}%` } }))
          : null,
        h("div", { className: "lbs-shell-grid" },
