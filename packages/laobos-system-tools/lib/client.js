...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    brandCss.textContent = `
      ...
      [data-laobos-brand-wordmark]{align-items:center!important;display:inline-flex!important;gap:9px!important;min-height:32px!important;min-width:112px!important}
      [data-laobos-brand-wordmark]>svg{display:none!important}
      [data-laobos-brand-wordmark]::before{background:url("${brandIcon}") center/contain no-repeat;content:"";display:block;flex:none;height:30px;width:30px}
      [data-laobos-brand-wordmark]::after{color:var(--dsw-alias-label-primary);content:"劳博士";font-size:20px;font-weight:650;letter-spacing:-.02em;white-space:nowrap}
      svg[data-laobos-brand-icon]{background:url("${brandIcon}") center/contain no-repeat!important;display:inline-block!important;flex:none;height:30px!important;width:30px!important}
      svg[data-laobos-brand-icon]>path{display:none!important}
    ...
    function applyProductBranding() {
      ...
      for (const svg of document.querySelectorAll("svg[viewBox]")) {
        ...
        if (viewBox === "0 0 182 24") {
          const container = svg.parentElement;
          if (!(container instanceof HTMLElement)) continue;
          container.dataset.laobosBrandWordmark = "true";
        } else if (viewBox === "0 0 23.16 17.04") {
          svg.dataset.laobosBrandIcon = "true";
        }
      }
